...
document.getElementById('ExibirSenhaR').addEventListener('click', (event) => {
    ...
    if (x.type === "password") {
        x.type = "text";
        x.placeholder = "1234";
        document.querySelector('#ExibirSenhaR').innerHTML = '<i style="width:15px" class="fa-solid fa-eye-slash"></i>';
    } else {
        x.type = "password";
        x.placeholder = "****";
        document.querySelector('#ExibirSenhaR').innerHTML = '<i style="width:15px" class="fa-solid fa-eye"></i>';
    }
});
document.getElementById('ExibirSenhaL').addEventListener('click', (event) => {
    ...
    if (x.type === "password") {
        x.type = "text";
        x.placeholder = "1234";
        document.querySelector('#ExibirSenhaL').innerHTML = '<i style="width:15px" class="fa-solid fa-eye-slash"></i>';
    } else {
        x.type = "password";
        x.placeholder = "****";
        document.querySelector('#ExibirSenhaL').innerHTML = '<i style="width:15px" class="fa-solid fa-eye"></i>';
    }
});
